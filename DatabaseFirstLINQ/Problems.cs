...
namespace DatabaseFirstLINQ
{
    class Problems
    {
        ...
        private void ProblemFive()
        {
            ...
            var users = _context.Users;
            DateTime dateTime = new(2016, 01, 01);

            var registeredBefore = users.Where(p => p.RegistrationDate < dateTime);
        ...
        private void ProblemSix()
        {
            ...
            // Then print each user's email and registration date to the console.
            var users = _context.Users;
            DateTime dateTimePast = new(2016, 01, 01);
            DateTime dateTimeFuture = new(2018, 01, 01);

            var registeredBefore = users.Where(p => p.RegistrationDate > dateTimePast && p.RegistrationDate < dateTimeFuture);
        ...
        private void ProblemEight()
        {
            ...
            var customerCarts = _context.ShoppingCarts.Include(sc => sc.Product).Include(sc => sc.User).Where(sc => sc.User.Email == "Afton@gmail.com");
            foreach (ShoppingCart shoppingCart in customerCarts)
            {
        ...
        private void ProblemNine()
        {
            ...
            var customerCarts = _context.ShoppingCarts.Include(sc => sc.Product).Include(sc => sc.User).Where(sc => sc.User.Email == "oda@gmail.com");
            decimal total = 0;
            foreach (ShoppingCart shoppingCart in customerCarts)
            {
               total+= shoppingCart.Product.Price;
            }
